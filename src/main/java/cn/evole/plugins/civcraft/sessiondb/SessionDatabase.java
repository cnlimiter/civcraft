...
public class SessionDatabase {
    ...
    public boolean add(String key, String value, int civ_id, int town_id, int struct_id) {
        ...
        SessionAsyncRequest request = new SessionAsyncRequest(SessionAsyncRequest.Operation.ADD, SessionAsyncRequest.Database.GAME, tb_prefix, se);
        request.queue();
        return true;
    }
    ...
    public boolean global_add(String key, String value) {
        ...
        //Fire async add to DB.
        SessionAsyncRequest request = new SessionAsyncRequest(SessionAsyncRequest.Operation.ADD, SessionAsyncRequest.Database.GLOBAL, "GLOBAL_", se);
        request.queue();
        return true;
    }
    ...
    public boolean delete_all(String key) {
        ...
        SessionAsyncRequest request = new SessionAsyncRequest(SessionAsyncRequest.Operation.DELETE_ALL, SessionAsyncRequest.Database.GAME, tb_prefix, se);
        request.queue();
        return true;
    }
    ...
    public boolean delete(int request_id, String key) {
        ...
        SessionAsyncRequest request = new SessionAsyncRequest(SessionAsyncRequest.Operation.DELETE, SessionAsyncRequest.Database.GAME, tb_prefix, se);
        request.queue();
        return true;
    }
    ...
    public boolean global_update(int request_id, String key, String newValue) {
        ...
        SessionAsyncRequest request = new SessionAsyncRequest(SessionAsyncRequest.Operation.UPDATE, SessionAsyncRequest.Database.GLOBAL, "GLOBAL_", se);
        request.queue();
        return true;
    }
    ...
    public boolean update(int request_id, String key, String newValue) {
        ...
        //Fire async to update DB.
        SessionAsyncRequest request = new SessionAsyncRequest(SessionAsyncRequest.Operation.UPDATE, SessionAsyncRequest.Database.GAME, tb_prefix, se);
        request.queue();
        return true;
    }
