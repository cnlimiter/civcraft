...
import cn.evole.plugins.civcraft.interactive.InteractiveBuildCommand;
...
import cn.evole.plugins.civcraft.threading.tasks.PostBuildSyncTask;
...
public abstract class Buildable extends SQLObject {
    ...
    public static void buildVerifyStatic(Player player, ConfigBuildableInfo info, Location centerLoc, CallbackInterface callback) throws CivException {
        ...
        String path = Template.getTemplateFilePath(info.template_base_name,
                Template.getDirection(player.getLocation()), Template.TemplateType.STRUCTURE, "default");
...
//                    }
    ...
    public ArrayList<StructureChest> getAllChestsById(final int start, final int end) {
        final ArrayList<StructureChest> chests = new ArrayList<>();
