...
import cn.evole.plugins.civcraft.components.TradeLevelComponent;
import cn.evole.plugins.civcraft.components.TradeShipResults;
...
public class TradeShip extends WaterStructure {
    ...
    public TradeShipResults consume(CivAsyncTask task) throws InterruptedException {
        ...
        if (this.goodsDepositPoints.size() == 0 || this.goodsWithdrawPoints.size() == 0) {
            ...
            tradeResult.setResult(TradeLevelComponent.Result.STAGNATE);
            return tradeResult;
        }
    ...
    public void process_trade_ship(CivAsyncTask task) throws InterruptedException, InvalidConfiguration {
        ...
        TradeLevelComponent.Result result = tradeResult.getResult();
        switch (result) {
            case STAGNATE:
    ...
    public TradeLevelComponent.Result getLastResult() {
