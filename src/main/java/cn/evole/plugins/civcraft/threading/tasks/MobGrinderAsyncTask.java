...
import cn.evole.plugins.civcraft.structure.MobGrinder;
import cn.evole.plugins.civcraft.structure.MobGrinder.Crystal;
        ...
        for (int i = 0; i < mobGrinder.skippedCounter + 1; i++) {
            ...
            for (ItemStack stack : contents) {
                ...
                try {
                    ...
                    this.updateInventory(UpdateInventoryRequest.Action.REMOVE, source_inv, newItem);
                } catch (InterruptedException e) {
                    return;
                }
                ...
                if (newItems.size() >= 1) {
                    ...
                    try {
                        for (ItemStack item : newItems) {
                            ...
                            this.updateInventory(UpdateInventoryRequest.Action.ADD, dest_inv, item);
                        }
                    } catch (InterruptedException e) {
                        return;
                    }
