...
import cn.evole.plugins.civcraft.threading.sync.SyncUpdateInventory;
...
public class MultiInventory {
    ...
    private int removeItemFromInventory(Inventory inv, String mid, int type, short data, int amount, Boolean direct) {
        ...
        if (direct) {
            ...
            this.updateInventory(inv, contents, UpdateInventoryRequest.Action.SET);
        }
    ...
    private void updateInventory(Inventory inv, ItemStack[] contents, UpdateInventoryRequest.Action action) {
    ...
    private void updateInventory(ItemStack stack, UpdateInventoryRequest.Action action) {
        UpdateInventoryRequest request = new UpdateInventoryRequest(SyncUpdateInventory.lock);
        request.stack = stack;
    ...
    public void addItemStack(ItemStack items) {
        this.updateInventory(items, UpdateInventoryRequest.Action.ADD);
    }
