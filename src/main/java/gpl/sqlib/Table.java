...
import gpl.sqlib.database.Database;
import gpl.sqlib.sql.SQLConnection;
import gpl.sqlib.sql.SQLDataType;
...
public class Table {
    ...
    public Table(String prefix, String name, Database database, SQLConnection sqlConnection) {
        this.name = name;
        this.prefix = prefix;
    ...
    public ArrayList<String> getIds() {
        return new ArrayList<>(dataContainers.keySet());
    }
